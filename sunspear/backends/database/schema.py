...
activities_table = Table('sgactivitystream_activities', metadata,
                         ...
                         Column('object', ForeignKey('sgactivitystream_objects.id', ondelete='SET NULL')),
                         Column('target', ForeignKey('sgactivitystream_objects.id', ondelete='SET NULL')),
                         Column('author', ForeignKey('sgactivitystream_objects.id', ondelete='SET NULL')),
                         Column('generator', ForeignKey('sgactivitystream_objects.id', ondelete='SET NULL')),
                         Column('provider', ForeignKey('sgactivitystream_objects.id', ondelete='SET NULL')),
                         Column('content', Text),
                         Column('published', DateTime(timezone=True), nullable=False),
                         Column('updated', DateTime(timezone=True)),
